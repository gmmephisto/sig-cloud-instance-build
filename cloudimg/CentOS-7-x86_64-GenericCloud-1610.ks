...
reboot
url --url="vault.centos.org/centos/7.2.1511/os/x86_64"
...
# System language
lang en_US.UTF-8
repo --name "os" --baseurl="http://vault.centos.org/centos/7.2.1511/os/x86_64/" --cost=100
repo --name "updates" --baseurl="http://vault.centos.org/centos/7.2.1511/updates/x86_64/" --cost=100
repo --name "extras" --baseurl="http://vault.centos.org/centos/7.2.1511/extras/x86_64/" --cost=100
